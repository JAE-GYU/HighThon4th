...
class MainRecyclerViewAdapter(var items: ArrayList<RecyclerItem>, var context: Context) : RecyclerView.Adapter<MainRecyclerViewAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_board_top, null)
